...
//            header('location: categoryList.php');
            ...
            echo "Customer Does Not Created!";
        }
    }
}
        ...
        <div class="row">
          ...
          <section class="col-lg-12 ">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <form action="createCustomer.php" method="post" id="createCustomer">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-4 offset-5">
                            ...
                            <button type="submit" name="createCustomer" class="btn btn-success">Create</button>
                        </div>
