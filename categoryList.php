...
if (isset($_GET['id'])) {
    ...
    if ($deleteData){
        ...
        echo "category does not deleted";
    }
                ...
                <section class="col-lg-12 ">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4>category List</h4>
                            <a class="btn btn-success btn-sm float-right " href="createCategory.php">
                        ...
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="editCategory.php?id=<?php echo $category['id'] ?>" class="btn btn-primary btn-sm" title="Edit">
                                            <i class="fa fa-edit"></i>
                                        </a>
                                        <a href="categoryList.php?id=<?php echo $category['id'] ?>" class="btn btn-danger btn-sm" title="Delete">
